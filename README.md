...
> An audio transcription and analysis application focused on converting spoken audio into readable and structured output through an AI-assisted workflow.

**Project Focus:**

* Audio transcription
* Speech-to-text processing
* Audio upload and analysis workflow
...
> An in-progress mobile-first community and event-support platform built with modern mobile, API, database, and security-focused development practices.

**Project Focus:**

* React Native mobile development
* Expo-based application architecture
* API and shared contract development
* PostgreSQL and Supabase
* Row-Level Security
* Database migrations and SQL functions
* Community interactions and discussions
* Event and moderation workflows
* Collaborative Git/GitHub development

**Tech Stack:** React Native, Expo, TypeScript, Fastify, PostgreSQL, Supabase, Zod
...
> GitHub statistics provided by third-party services may update later than the official contribution calendar. My GitHub contribution graph remains the primary source for my latest activity.
...
<picture>
  <source
    ...
    srcset="https://raw.githubusercontent.com/kazamijimin/kazamijimin/output/github-contribution-grid-snake-dark.svg"
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="https://raw.githubusercontent.com/kazamijimin/kazamijimin/output/github-contribution-grid-snake.svg"
  />
  <img
    alt="GitHub Contribution Graph"
    src="https://raw.githubusercontent.com/kazamijimin/kazamijimin/output/github-contribution-grid-snake.svg"
  />
</picture>
